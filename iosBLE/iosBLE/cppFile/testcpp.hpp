...
#ifndef ppgAlgorithm_hpp
#define ppgAlgorithm_hpp

#include <stdio.h>

#endif /* ppgAlgorithm_hpp */
...
extern "C" {
    ...
    void maxim_heart_rate_and_oxygen_saturation(int32_t *pun_ir_buffer, int32_t n_ir_buffer_length, int32_t *pun_red_buffer, int32_t *pn_spo2, int8_t *pch_spo2_valid,
